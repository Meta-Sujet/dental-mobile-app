...
class PrettyLogInterceptor extends Interceptor {
  ...
  void onRequest(
    ...
    if (request) {
      ...
      output
          .writeln(_keyValue('responseType', options.responseType.toString()));
    ...
    if (requestHeader) {
      ...
      options.headers.forEach(
          (String key, dynamic v) => output.writeln(_keyValue(' $key', v)));
    }
    if (requestBody) {
      output.writeln('data:');
  ...
  String _getResponseString(Response<dynamic> response) {
    ...
    if (responseHeader) {
      ...
      response.headers
          ...
          .forEach((String key, dynamic v) =>
              output.writeln(_keyValue(' $key', v.join('\r\n\t'))));
    }
    if (responseBody) {
